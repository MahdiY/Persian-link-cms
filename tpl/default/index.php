...
<table align=center border="0" width="600" height="100%" cellspacing="0" cellpadding="0">
    <tr>
        <td height="24" width="607"
            style="border-left: 3px solid #FFFFFF;border-right: 3px solid #FFFFFF;padding-left: 2px;padding-right: 2px"
 ...
 text-align:center">Powered By <a href="http://persianscript.ir/" target="_blank" title="پرشين اسکريپت">Persian Link
                    CMS</a></p>
            <hr size="1" color="#F1F6FB" style="margin-top: 0;
 margin-bottom: 0">
