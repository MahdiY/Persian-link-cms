...
<div id="menu">
    <ul>
        <li class="act"><a href="<?php echo get_option( 'site_url' ); ?>">صفحه نخست</a></li>
        <li><a href="mailto:<?php echo get_option( 'email' ); ?>">تماس با ما</a></li>
        <li><a href="<?php echo get_option( 'site_url' ); ?>box.php">لینک باکس</a></li>
        <li><a href="javascript:popUp('<?php echo get_option( 'site_url' ); ?>send.php')">ارسال لینک</a></li>
        <li style="float: left;"><a href="<?php echo get_option( 'site_url' ); ?>rss.php"><img
                        src="<?php echo theme_dir(); ?>img/rss.png"/></a></li>
    </ul>
</div>
...
<div id="page" class="copyright">
    Powered By <a rel="nofollow" href="http://www.persianlinkcms.ir/" target="_blank" title="پرشین اسکریپت">Persian Link
        CMS</a> - Design By <a rel="nofollow" href="http://MahdiY.ir" target="_blank" title="مهدی">MahdiY</a>
</div>
