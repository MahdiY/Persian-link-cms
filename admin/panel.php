...
<div id="wrapper">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="<?php echo get_option( 'site_url' ); ?>" target="_blank"><i
                                    class="fa fa-gear fa-fw"></i> مشاهده سایت</a></li>
                    <li><a href="<?php echo get_option( 'site_url' ); ?>admin/panel.php?act=addlink"><i
                                    class="fa fa-gear fa-fw"></i> افزودن لینک</a>
                    </li>
                    <li class="divider"></li>
    ...
    <div id="page-wrapper">
		...
		$page = isset( $_GET['act'], $pages[ $_GET['act'] ] ) ? $pages[ $_GET['act'] ] : $pages[0];
