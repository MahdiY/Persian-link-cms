...
elseif(isset($_GET['link'])){
	function persian($str) {
		$alphabet = array (
			...
			'U¾' => 'پ', '??' => 'ت', '?«' => 'ث', '?¬' => 'ج', '?†' => 'چ', '?­' => 'ح', '?®' => 'خ', '?¯' => 'د', '?°' => 'ذ',
			'?±' => 'ر', '?²' => 'ز', '??' => 'ژ', '?³' => 'س', '?´' => 'ش', '?µ' => 'ص', '?¶' => 'ض', '?·' => 'ط', '?¸' => 'ظ',
			'?¹' => 'ع', '??' => 'غ', 'U?' => 'ف', 'U‚' => 'ق', '?©' => 'ک', '?¯' => 'گ', 'U„' => 'ل', 'U…' => 'م', 'U†' => 'ن',
			'Uˆ' => 'و', 'U‡' => 'ه', 'UŒ' => 'ي', 'U?' => 'ي', 'U€' => '?', '?©' => 'ة', 'U?' => 'َ', 'U?' => 'ُ', 'U?' => 'ِ',
			'U‘' => 'ّ', 'U‹' => 'ً', 'UŒ' => 'ٌ', 'U?' => 'ٍ', '?Œ' => '،', '?›' => '؛', ',' => ',', '??' => '؟' , 'â€Œ' => " " ,
			"â€œ" => "«" , "â€" => "»" , "U€U€" => "" , "A" => "" , 'Uƒ' => 'ک' , 'U€' => '' , '»?' => ' '
		);
	...
	foreach($links as $link){
		...
		$d = explode(" ",$link['date']);
		$search = array('فروردين','ارديبهشت','خرداد','تير','مرداد','شهريور','مهر','آبان','آذر','دي','بهمن','اسفند');
