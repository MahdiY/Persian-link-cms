...
if ( isset( $_POST['submit'] ) ) {
	...
	if ( $createtblfeeds ) {
		...
		$error = '<div class="error"><span class="fontawesome-remove-sign"></span> یک خطا در هنگام ایجاد جدول سایت ها رخ داده است</div>';
	}
	...
	if ( $createtbllinks ) {
		...
		$error .= '<div class="error"><span class="fontawesome-remove-sign"></span> یک خطا در هنگام ایجاد جدول لینک ها رخ داده است</div>';
	}
	...
	if ( $createtbloptions ) {
		...
		$error .= '<div class="error"><span class="fontawesome-remove-sign"></span> یک خطا در هنگام ایجاد جدول تنظیمات رخ داده است</div>';
	}
	...
	if ( $insertoptions ) {
		...
		$error .= '<div class="error"><span class="fontawesome-remove-sign"></span> یک خطا در هنگام درون ریزی اطلاعات پیشفرض تنظیمات رخ داده است</div>';
	}
